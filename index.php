    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Service Régional des Pêches et de la Surveillance de SEDHIOU</h2>
          <h4>Plateforme de Gestion des permis de <br>Pêche artisanal, des Embarcations et des
            Pêcheurs</h4>
        </div>
        ...
        <div class="row mt-2">
          ...
          <div class="col-lg-4 col-md-6 icon-box">
            ...
            <p class="description">Evènements les plus récents</p>
          </div>
        </div>
